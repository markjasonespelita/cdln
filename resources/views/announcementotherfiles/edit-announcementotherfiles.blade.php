...
@section('content')
    <h1>Edit Announcementotherfiles</h1>

    <div class='card'>
        <div class='card-body'>
            <form action='{{ route('announcementotherfiles.update', $item->id) }}' method='POST'>
                @csrf
        ...
        <div class='form-group'>
            ...
            <input type='text' class='form-control' id='file' name='file' value='{{ $item->file }}' required>
        </div>
