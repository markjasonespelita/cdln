...
@section('content')
    ...
    <div class="container-fluid bg-primary px-0 px-md-5 mb-5">
        <div class="row align-items-center px-3">
            <div class="col-lg-6 text-center text-lg-left">
                <h4 class="text-white mb-4 mt-5 mt-lg-0">Welcome to...</h4>
                <h1 class="display-3 font-weight-bold text-white">Colegio De Las Navas</h1>
                <p class="text-white mb-4">Where learning meets excellence — we nurture minds, shape character, and inspire a lifelong passion for knowledge.  
      Join our vibrant community and be part of a legacy that values growth, discipline, and heart.</p>
                <a href="" class="btn btn-secondary mt-1 py-3 px-5">Learn More</a>
            </div>
            <div class="col-lg-6 text-center text-lg-right">
                <img class="img-fluid mt-5" src="/design/img/custom/showcase.png" alt="">
            </div>
        </div>
    </div>
    <!-- Header End -->
                    ...
                    <div class="row pt-2 pb-4">
                        ...
                        <div class="col-6 col-md-8">
                            ...
                            <ul class="list-inline m-0">
                                <li class="py-2 border-top border-bottom"><i class="fa fa-check text-primary mr-3"></i>Competence</li>
                                <li class="py-2 border-bottom"><i class="fa fa-check text-primary mr-3"></i>Diversity</li>
                                <li class="py-2 border-bottom"><i class="fa fa-check text-primary mr-3"></i>Life-Long Learning</li>
                                <li class="py-2 border-bottom"><i class="fa fa-check text-primary mr-3"></i>Nobility.</li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 pb-1">
                    <div class="d-flex bg-light shadow-sm border-top rounded mb-4" style="padding: 30px;">
                        <i class="flaticon-047-target h1 font-weight-normal text-primary mb-3"></i>
                        <div class="pl-4">
                            <h4>Mission</h4>
                ...
                <div class="col-lg-6 col-md-6 pb-1">
                    <div class="d-flex bg-light shadow-sm border-top rounded mb-4" style="padding: 30px;">
                        <i class="flaticon-014-vision h1 font-weight-normal text-primary mb-3"></i>
                        <div class="pl-4">
                            <h4>Vision</h4>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7 mb-5 mb-lg-0">
                    <p class="section-title pr-5"><span class="pr-2">Objectives</span></p>
                    <h1 class="mb-4">Our Objectives</h1>
                    <ul class="list-inline m-0">
                        <li class="py-2"><i class="fa fa-check text-success mr-3"></i>Provide quality instruction by tapping qualified, competent, and dedicated school personnel utilizing the latest technology and continuously myrading facilities, and manifesting proactive attitude towards at work.</li>
                        <li class="py-2"><i class="fa fa-check text-success mr-3"></i>Develop students with outstanding achievements and produce graduates with excellent performance in the related professional licensure   examinations and or in their chosen field. </li>
                        <li class="py-2"><i class="fa fa-check text-success mr-3"></i>Institutionalize a dynamic research program as an aid to effective classroom instruction as well as for the sustainable development of the Municipality of Las Navas and its partner local government units.</li>
                        <li class="py-2"><i class="fa fa-check text-success mr-3"></i>Establish and maintain linkage with conumunity-based or people's organizations for partnership undertakings in the implementation of socio-economic development project, programs and activities.</li>
                        <li class="py-2"><i class="fa fa-check text-success mr-3"></i>Coordinate with other local colleges and universitics as well as other institutions for collaboration, cooperation, complementation and convergence necessary for the advancement of Colegio De Las Navas as well as the Municipulity of Las Navas and its partner local government units.</li>
                        <li class="py-2"><i class="fa fa-check text-success mr-3"></i>Initiate and facilitate in providing training and development to the officials and employees as well as leaders and constituents of the Municipality of Las Navas and its partner local government wits.</li>
                    </ul>
                    {{-- <a href="" class="btn btn-primary mt-4 py-2 px-4">Book Now</a> --}}
                </div>
                <div class="col-lg-5">
                    <div class="card border-0">
                        <p class="section-title pr-5"><span class="pr-2">Goal</span></p>
                        <h1 class="mb-4">Our Goal</h1>
                        <ul class="list-inline m-0">
                            <li class="py-2"><i class="fa fa-check text-success mr-3"></i>Implement a curriculum as frontiers of knowledge and inculcate ethics and values.</li>
                            <li class="py-2"><i class="fa fa-check text-success mr-3"></i>Tap competent and committed professionals to ensure quality education.</li>
                            <li class="py-2"><i class="fa fa-check text-success mr-3"></i>Continue upgrading teaching and non-teaching personnel through education, training and seminu's.</li>
                            <li class="py-2"><i class="fa fa-check text-success mr-3"></i>Caver to the demands of the students in the attainment of quality education by providing instructions thu are current in content and adopting the state of the art in teaching delivery. 5) Adopt the latest technology and continuous upgrading of facilities; and</li>
                            <li class="py-2"><i class="fa fa-check text-success mr-3"></i>Offer programs relevant to the needs of the community towards economic upliftment. </li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-4 mb-5">
                    <div class="card border-0 bg-light shadow-sm pb-2">
                        <img class="card-img-top mb-2" src="/design/img/class-1.jpg" alt="">
                ...
                <div class="col-lg-4 mb-5">
                    <div class="card border-0 bg-light shadow-sm pb-2">
                        <img class="card-img-top mb-2" src="/design/img/class-2.jpg" alt="">
                        <div class="card-body text-center">
                ...
                <div class="col-lg-4 mb-5">
                    <div class="card border-0 bg-light shadow-sm pb-2">
                        <img class="card-img-top mb-2" src="/design/img/class-3.jpg" alt="">
                        <div class="card-body text-center">
    ...
    <div class="container-fluid py-5">
        <div class="container p-0">
            <div class="text-center pb-2">
                <p class="section-title px-5"><span class="px-2">Announcements</span></p>
                ...
                <div class="owl-carousel testimonial-carousel">
                    @forelse (App\Models\Announcements::where('status', 'published')->where('departments_id', $department->id)->get() as $announcement)
                        <div class="testimonial-item px-3">
                            ...
                            <a href="{{ url('/announcement-details/'.$announcement->id) }}" class="btn btn-primary mt-4 py-2 px-4">View Details</a>
                        </div>
                    @empty
                        No Accounements...
                    @endforelse
    ...
    <div class="container-fluid py-5">
        <div class="container p-0">
            <div class="text-center pb-2">
                <p class="section-title px-5"><span class="px-2">Events</span></p>
            ...
            <div class="owl-carousel testimonial-carousel">
                @forelse (App\Models\Events::all() as $event)
                    <div class="testimonial-item px-3">
                        <div class="bg-light shadow-sm rounded mb-4 p-4">
                            <h3 class="fas fa-quote-left text-primary mr-3"> {{ $event->title }}</h3>
                        ...
                        <a href="{{ url('/event-details/'.$event->id) }}" class="btn btn-primary mt-4 py-2 px-4">View Details</a>
                    </div>
                @empty
                    No Accounements...
                @endforelse
            ...
            <div class="row pb-3">
                <div class="col-lg-4 mb-4">
                    <div class="card border-0 shadow-sm mb-2">
                        <img class="card-img-top mb-2" src="/design/img/blog-1.jpg" alt="">
                ...
                <div class="col-lg-4 mb-4">
                    <div class="card border-0 shadow-sm mb-2">
                        <img class="card-img-top mb-2" src="/design/img/blog-2.jpg" alt="">
                        <div class="card-body bg-light text-center p-4">
                            <h4 class="">Diam amet eos at no eos</h4>
                            <div class="d-flex justify-content-center mb-3">
                                <small class="mr-3"><i class="fa fa-user text-primary"></i> Admin</small>
                ...
                <div class="col-lg-4 mb-4">
                    <div class="card border-0 shadow-sm mb-2">
                        <img class="card-img-top mb-2" src="/design/img/blog-3.jpg" alt="">
                        <div class="card-body bg-light text-center p-4">
                            <h4 class="">Diam amet eos at no eos</h4>
                            <div class="d-flex justify-content-center mb-3">
                                <small class="mr-3"><i class="fa fa-user text-primary"></i> Admin</small>
